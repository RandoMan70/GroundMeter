...
//Sensor addresses, production
DeviceAddress airAddress={0x28, 0x6D, 0x77, 0xAE, 0x06, 0x00, 0x00, 0xC6};
DeviceAddress groundAddress={0x28, 0x84, 0x84, 0xAE, 0x06, 0x00, 0x00, 0x91};
